...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data-dir", "-i", default="../preprocessing/training_data", help="Directory containing the data", required=False
    )
    parser.add_argument(
        "--dataset-name", "-d", default="training_data", help="Name of the dataset", required=False
    )
    parser.add_argument(
        "--split", "-s", type=float, default=0.8, help="train/test split (default: 0.8)"
    )
    parser.add_argument(
        "--data-splits-dir", "-o", default="../preprocessing/data_splits", help="Data splits directory"
    )
